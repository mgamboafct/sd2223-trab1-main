...
public interface FeedsService {
	...
	@WebMethod
	Message getUserMessage(String user, long mid) throws FeedsException;;

	@WebMethod
	List<Message> getUserMessages(String user, long time) throws FeedsException;;
	...
	@WebMethod
	long userLastUpdate(String user) throws FeedsException;;
}
