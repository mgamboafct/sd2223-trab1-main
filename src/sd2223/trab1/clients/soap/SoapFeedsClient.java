...
public class SoapFeedsClient extends SoapClient implements Feeds {
    ...
    public Result<Message> getUserMessage(String user, long mid) {
        return super.reTry( () -> super.toJavaResult( () -> stub().getUserMessage(user, mid) ) );
    }

    @Override
    public Result<List<Message>> getUserMessages(String user, long time) {
        return super.reTry( () -> super.toJavaResult( () -> stub().getUserMessages(user, time) ) );
    }
    ...
    public Result<Long> userLastUpdate(String user) {
        return super.reTry( () -> super.toJavaResult( () -> stub().userLastUpdate(user) ) );
    }
