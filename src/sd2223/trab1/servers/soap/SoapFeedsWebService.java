...
public class SoapFeedsWebService extends SoapWebService<FeedsException> implements FeedsService {
    ...
    @Override
    public Message getUserMessage(String user, long mid) throws FeedsException {
        return super.fromJavaResult( impl.getUserMessage(user, mid));
    }

    @Override
    public List<Message> getUserMessages(String user, long time) throws FeedsException {
    ...
    @Override
    public long userLastUpdate(String user) throws FeedsException {
